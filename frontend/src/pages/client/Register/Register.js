...
function Register() {
    ...
    return (
        <section class="bg-gray-50 min-h-screen flex items-center justify-center" style={{backgroundImage: `url(https://wallpapersmug.com/download/2048x1152/7a22c5/forest_mountains_sunset_cool_weather_minimalism.jpg)`,  backgroundRepeat  : 'no-repeat', backgroundPosition: 'center', } }>
